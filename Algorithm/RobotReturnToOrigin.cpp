...
class Solution 
{
    ...
    {
        vector<int> vector2 = {0, 0};
        
        for (char c : moves)
        {
            switch(c)
            {
                case 'L': vector2[0]--; break;
                case 'R': vector2[0]++; break;
                case 'U': vector2[1]++; break;
                case 'D': vector2[1]--; break;
            }
        }
        
        return vector2[0] == 0 && vector2[1] == 0 ? true : false;
    }
};
